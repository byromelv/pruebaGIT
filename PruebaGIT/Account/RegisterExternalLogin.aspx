<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="RegisterExternalLogin.aspx.vb" Inherits="PruebaGIT.RegisterExternalLogin" Async="true" %>

<%@ Import Namespace="PruebaGIT" %>
